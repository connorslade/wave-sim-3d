use compute::export::egui::{emath::Numeric, DragValue, Ui};
...
impl<'a, Num: Numeric> SciDragValue<'a, Num> {
    ...
    pub fn show(self, ui: &mut Ui) {
        ...
        let speed = 10.0_f64.powi(exponent - (self.significant_figures as i32 - 1));
        ...
        ui.add(
            DragValue::new(self.value)
                ...
                .custom_formatter(|val, _| {
                    ...
                    let decimal_places = self.significant_figures as usize - 1;
